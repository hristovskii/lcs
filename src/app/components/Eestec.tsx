        ...
        <section className="mx-auto my-12 lg:px-16 px-8">
            <div className="lg:flex lg:flex-row lg:gap-3 grid">
                <div className="basis-4/5 lg:order-1 order-2">
                        ...
                        <div className="rounded bg-eestec mt-3 grow px-6 py-5 flex items-end lg:block hidden" style={{ height: "323px" }}
                        >
                            ...
                            <h3 className="text-4xl text-white font-eestec font-light">What kind of music do Minecraft players listen to? Bed-rock and roll!</h3>
                            <h3 className="text-4xl text-white font-eestec font-light">Guys with big noses obsessed with making money, is this a coincidence?</h3>
                        </div>
                </div>
                <div className="basis-1/5 lg:order-2 order-1">
                    ...
                    <div style={{backgroundImage: `url(${Photo2.src})`, height: "400px",
                                 backgroundPosition: "center",
                                 backgroundRepeat: "no-repeat",
